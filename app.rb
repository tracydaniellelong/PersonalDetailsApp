...
post '/favoritepet' do
	...
	numthree = params[:numthree]
	pet = params[:pet]
	redirect '/list?fname=' + first_name + '&lname=' + last_name + '&age=' + age + '&color=' + color + '&numone=' + numone + '&numtwo=' + numtwo + '&numthree=' + numthree + '&pet=' + pet
end
...
get '/list' do
	...
	numthree = params[:numthree]
	pet = params[:pet]
	erb :list, locals: {lname: last_name, fname: first_name, age: age, color: color, numone: numone, numtwo: numtwo, numthree: numthree, pet: pet}
end
